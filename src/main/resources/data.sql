...
VALUES ('2024-01-07', 100005, 'Том-ям', 600),
       ...
       (CURRENT_DATE(), 100007, 'Шоколадный мусс', 800),
       (CURRENT_DATE(), 100007, 'Торт Наполеон', 300),
       (CURRENT_DATE(), 100007, 'Молочный коктейль', 220);

INSERT INTO VOTE (REGISTERED, USER_ID, RESTAURANT_ID)
VALUES ('2024-01-07', 100001, 100005),
       ('2024-01-07', 100002, 100006),
       ('2024-09-08', 100001, 100007),
       ('2019-09-08', 100002, 100005);